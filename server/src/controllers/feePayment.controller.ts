...
export const createFeePaymentSummary = handleAsync(async (req: Request, res: Response) => {
  const summary = await feePaymentRepo.createFeePaymentSummary(req.body);
  res.status(201).json(summary);
});

export const getAllFeePaymentSummaries = handleAsync(async (_req: Request, res: Response) => {
  const summaries = await feePaymentRepo.getAllFeePaymentSummaries();
  res.json(summaries);
});

export const getFeePaymentSummaryById = handleAsync(async (req: Request, res: Response) => {
...
export const getFeePaymentSummariesByStudent = handleAsync(async (req: Request, res: Response) => {
  const summaries = await feePaymentRepo.getFeePaymentSummariesByStudent(req.params.studentId);
  res.json(summaries);
});

export const updateFeePaymentSummary = handleAsync(async (req: Request, res: Response) => {
...
export const deleteFeePaymentSummary = handleAsync(async (req: Request, res: Response) => {
...
export const calculateTotalFeesPaidByStudent = handleAsync(async (req: Request, res: Response) => {
...
export const calculateTotalFeesPaidByAllStudents = handleAsync(async (_req: Request, res: Response) => {
  const total = await feePaymentRepo.calculateTotalFeesPaidByAllStudents();
  res.json({ totalPaid: total });
});

export const addPaymentToSummary = handleAsync(async (req: Request, res: Response) => {

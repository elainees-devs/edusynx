...
export * from './school-core/academic-year.model'  
export * from './people/super-admin.model'
export * from './people/user.model'
export * from './cbc.model'
export * from './people/guardian.model'
export * from './people/teacher.model'
export * from './people/staff.model'
export * from './people/student.model'
export * from './academics/enrollment.model'
export * from './academics/class.teacher.model'
export * from './academics/subject.model'  
export * from './academics/teacher-subject.model'    

...
const baseInvoiceObjectSchema = z.object({
...
const baseInvoiceSchema = baseInvoiceObjectSchema.superRefine((data, ctx) => {
...
export const updateInvoiceSchema = baseInvoiceObjectSchema.partial().superRefine((data, ctx) => {
  if (
